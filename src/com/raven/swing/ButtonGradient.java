...
public class ButtonGradient extends JButton {
    ...
    private Color color3 = Color.decode("#F11712");
    private Color color2 = new Color(36, 104, 155);;
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        g2.setPaint(gra);
        g2.fillRoundRect(0, 0, width, height, height/4, height/4);
        //  Add Style
        createStyle(g2);
        if (pressed) {
            paintPressed(g2);
