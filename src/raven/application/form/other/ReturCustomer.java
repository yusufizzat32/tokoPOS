 ...
 * @author yusuf
 */
public class ReturCustomer extends javax.swing.JDialog {

    /**
     * Creates new form ReturCustomer
     */
    ...
    public ReturCustomer(java.awt.Frame parent, boolean modal,int row, modelBarang barang,FormMasterProduk formMasterProduk) {
        super(parent, modal);
    this.barang = barang;
    this.row = row;
...
private void handleBarcodeInput(String barcode) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReturCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                ReturCustomer dialog = new ReturCustomer(new javax.swing.JFrame(), true, 1, null, formMasterProduk);
